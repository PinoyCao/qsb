...
public class QueryAlluser {
	...
	public static Data queryalluser(String size,String page,String sort){
		 ...
		 try {
			 ...
			 HttpGet httpget = new HttpGet(Http_util.getURL()+API.getUSERVIEW_API()+"?"+param);
	         //执行Get请求，  
			 datainfo = SingleHttpClient.executeForData(httpget,User.class); 
	         //得到响应体  
